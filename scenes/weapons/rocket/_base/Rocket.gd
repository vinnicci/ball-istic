...
var _left_curve: Resource = preload("res://scenes/weapons/rocket/_base/RocketProjLeftCurve.tres")
var _right_curve: Resource = preload("res://scenes/weapons/rocket/_base/RocketProjRightCurve.tres")
